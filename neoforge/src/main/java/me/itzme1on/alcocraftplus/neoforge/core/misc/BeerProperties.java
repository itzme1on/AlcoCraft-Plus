package me.itzme1on.alcocraftplus.neoforge.core.misc;

import me.itzme1on.alcocraftplus.neoforge.core.registries.EffectsRegistry;
...
public class BeerProperties {
    ...
    public static final FoodProperties ICE_BEER = new FoodProperties.Builder()
            ...
            .saturationMod(0.6f)
            .alwaysEat()
            .effect(new MobEffectInstance(EffectsRegistry.FREEZE.get(), 6000, 0), 1.0f)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f)
            .build();
    ...
    public static final FoodProperties MAGNET_PILSNER = new FoodProperties.Builder()
            ...
            .saturationMod(0.6f)
            .alwaysEat()
            .effect(new MobEffectInstance(EffectsRegistry.ATTRACT.get(), 6000, 0), 1.0f)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f)
            .build();
    ...
    public static final FoodProperties NIGHT_RAUCH = new FoodProperties.Builder()
            ...
            .saturationMod(0.6f)
            .alwaysEat()
            .effect(new MobEffectInstance(EffectsRegistry.PHANTOM.get(), 12000, 0), 1.0f)
    ...
    public static final FoodProperties WITHER_STOUT = new FoodProperties.Builder()
            ...
            .saturationMod(0.6f)
            .alwaysEat()
            .effect(new MobEffectInstance(EffectsRegistry.WITHER.get(), 3600, 0), 1.0f)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f)
            .build();
}
