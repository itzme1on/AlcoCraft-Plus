...
public class KegGui extends AbstractContainerScreen<KegGuiHandler> {
    private static final ResourceLocation TEXTURE = IdentifierUtil.of("textures/gui/keg_gui.png");
    private static final ResourceLocation BG = IdentifierUtil.of("textures/gui/dark_bg.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        guiGraphics.blit(RenderType::guiTextured, BG,
