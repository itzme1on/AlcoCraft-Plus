package me.itzme1on.alcocraftplus.core.compat.jei.keg;

import me.itzme1on.alcocraftplus.AlcoCraftPlus;
import me.itzme1on.alcocraftplus.core.compat.jei.AlcoJEIPlugin;
...
public class KegCategory implements IRecipeCategory<KegRecipes> {
    ...
    public final static ResourceLocation TEXTURE = IdentifierUtil.of("textures/gui/keg_recipe.png");
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, KegRecipes recipe, IFocusGroup focuses) {
        for (int i = 0; i < 4; i++)
            AlcoJEIPlugin.addSlot(builder, 12 + 24 * i, SLOTS_Y_POSITION, recipe.getIngredients().get(i));
