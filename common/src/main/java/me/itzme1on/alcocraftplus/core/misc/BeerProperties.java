...
public final class BeerProperties {
    ...
    public static final FoodProperties ICE_BEER = new FoodProperties.Builder()
            ...
            .saturationModifier(0.6f)
            .alwaysEdible()
            .effect(new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(EffectsRegistry.FREEZE.get()), 6000, 0), 1.0f)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f)
            .build();
    ...
    public static final FoodProperties MAGNET_PILSNER = new FoodProperties.Builder()
            ...
            .saturationModifier(0.6f)
            .alwaysEdible()
            .effect(new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(EffectsRegistry.ATTRACT.get()), 6000, 0), 1.0f)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f)
            .build();
    ...
    public static final FoodProperties NIGHT_RAUCH = new FoodProperties.Builder()
            ...
            .saturationModifier(0.6f)
            .alwaysEdible()
            .effect(new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(EffectsRegistry.PHANTOM.get()), 12000, 0), 1.0f)
    ...
    public static final FoodProperties WITHER_STOUT = new FoodProperties.Builder()
            ...
            .saturationModifier(0.6f)
            .alwaysEdible()
            .effect(new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(EffectsRegistry.WITHER.get()), 3600, 0), 1.0f)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f)
            .build();
