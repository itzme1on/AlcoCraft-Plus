...
public class ItemsRegistry {
                    ...
                    .component(
                            ...
                            Consumable.builder()
                                    ...
                                    .onConsume(new ApplyStatusEffectsConsumeEffect(
                                            new MobEffectInstance(MobEffects.CONFUSION, 100, 0), 1.0f))
                                    .build()
                    )
    );
    ...
    public static final RegistrySupplier<Item> CHORUS_ALE = registerItemWithProps(
            ...
            () -> drinkProps(
                    ...
                    new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f
            )
    );
    public static final RegistrySupplier<Item> DIGGER_BITTER = registerItemWithProps(
            ...
            () -> drinkProps(
                    ...
                    new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 1), 1.0f,
                    new MobEffectInstance(MobEffects.CONFUSION, 200, 0), 1.0f
            )
    );
    ...
    public static final RegistrySupplier<Item> NETHER_STAR_LAGER = registerItemWithProps(
            ...
            () -> drinkProps(
                    ...
                    new MobEffectInstance(MobEffects.JUMP, 6000, 0), 1.0f,
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 6000, 1), 1.0f,
                    new MobEffectInstance(MobEffects.HEALTH_BOOST, 6000, 0), 1.0f,
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 3600, 0), 1.0f
            )
    );
